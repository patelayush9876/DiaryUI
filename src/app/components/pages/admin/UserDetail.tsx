...
import { ArrowLeft, Mail, Calendar, Activity, BookOpen, Lock, Shield, AlertCircle } from "lucide-react";
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <Alert className="mb-6 bg-green-50 border-green-200">
          ...
          <AlertDescription className="text-green-800">
            <strong>Privacy Notice:</strong> User diary entries are end-to-end encrypted 
            and cannot be accessed by administrators. Only metadata and activity statistics 
            are visible below.
          </AlertDescription>
        </Alert>
        ...
        <Card className="border-slate-200 bg-slate-50">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">
              All diary entries, personal notes, and user content are end-to-end encrypted. 
              As an administrator, you can only view profile information and activity statistics 
